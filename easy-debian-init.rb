...
#
#--------------------------------------------------------------------------
#License: License: [MIT license](http://opensource.org/licenses/MIT)
#
#--------------------------------------------------------------------------
...
class Core
  ...
  def save_file(name,content)
    ...
    date_now = Time.now
    puts "#{Tty.blue}Creating a file #{name} at: #{Tty.white}#{date_now}#{Tty.reset}"
    file << "# Generated by #{script_name} script created by Douglas Quintiliano dos Santos\n"
    file << "# Date and time of the file: #{date_now}: #{name}\n"
    file << content
    check_file(name)
  end
  ...
  def check_file(name)
    if File.exists?(name)
      puts "#{Tty.blue}File Created #{Tty.white} #{name} #{Tty.reset}"
    end
  end
